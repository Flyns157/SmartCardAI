...
class CFRAgent(object):
    ...
    def __init__(self, env:Env, model_path:str='./cfr_model')->None:
        ''' Initilize Agent
    ...
    def traverse_tree(self, probs:float, player_id:int)->list:
    ...
    def get_state(self, player_id:int)->tuple[str,list]:
