...
def type_check(func: types.FunctionType):
    """
    ...
    def wrapper(*args, **kwargs):
        ...
        for param_name, param_value in all_args.items():
            ...
            if param_name in param_type_hints:
                _check_type(
                    param_value, param_type_hints[param_name], param_name)
...
def reset_default_args(func):
    ...
    def wrapper(*args, **kwargs):
        ...
        default_names = func.__code__.co_varnames[len(
...
if __name__ == "__main__":
    ...
    # Provides custom details
    example_func_with_defaults([1, 2, 3], "Another test", (100, "data"))
